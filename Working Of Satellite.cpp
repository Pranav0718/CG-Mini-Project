...
{
 glClear(GLUT_COLOR_BUFFER_BIT | GLUT_DEPTH_BUFFER_BIT);
 glLoadIdentity();
...
/* Select the projection matrix and reset it then
 ...
 glMatrixMode(GLUT_PROJECTION);
 glLoadIdentity();
 gluPerspective(30.0f,(GLfloat)640/(GLfloat)480,0.1f,200.0f);
 /* Select the modelview matrix, which we alter with rotatef() */
 glMatrixMode(GLUT_MODELVIEW);
 glLoadIdentity();
 glClearDepth(2.0f);
 glEnable(GLUT_DEPTH_TEST);
glEnable( GLUT_COLOR_MATERIAL );
 glDepthFunc(GLUT_LEQUAL);
}
void display()
{
glClear(GLUT_COLOR_BUFFER_BIT | GLUT_DEPTH_BUFFER_BIT);
...
glMaterialfv(GLUT_FRONT,GLUT_AMBIENT,mat_ambient);
glMaterialfv(GLUT_FRONT,GLUT_DIFFUSE,mat_diffuse);
glMaterialfv(GLUT_FRONT,GLUT_SPECULAR,mat_specular);
glMaterialfv(GLUT_FRONT,GLUT_SHININESS,mat_shininess);
GLfloat lightIntensity[]={1.7f,1.7f,1.7f,1.0f};
GLfloat light_position3[]={0.0f,8.0f,10.0f,0.0f};
glLightfv(GLUT_LIGHT0,GLUT_POSITION,light_position3);
glLightfv(GLUT_LIGHT0,GLUT_DIFFUSE,lightIntensity);
GLfloat lightIntensity1[]={1.7f,1.7f,1.7f,1.0f};
GLfloat light_position31[]={-2.0f,8.0f,10.0f,0.0f};
 
glLightfv(GLUT_LIGHT1,GLUT_POSITION,light_position31);
glLightfv(GLUT_LIGHT1,GLUT_DIFFUSE,lightIntensity1);
glEnable(GLUT_COLOR_MATERIAL);
glFlush();
glutSwapBuffers();
 }
...
glEnable(GLUT_LIGHTING);
glEnable(GLUT_LIGHT0);
glEnable(GLUT_LIGHT1);
glShadeModel(GLUT_SMOOTH);
glEnable(GLUT_DEPTH_TEST);
glEnable(GLUT_NORMALIZE);
